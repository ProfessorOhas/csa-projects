...
public class Magpie5
{
	...
	public String getResponse(String statement)
	{
		...
		else if (findKeyword(statement, "sloth") >= 0)
		{
			response = "Sloths are really cute";
		}
		else if (findKeyword(statement, "school") >= 0)
		{
			response = "Did you know that people from gen-z had to go to school THROUGH A PANDEMIC??!!";
		}
	...
	private String [] randomResponses = {
			...
			"You don't say.",
			"That's cool.",
			"Woah. Explain that more.",
			"Do tell me more.",
			"Cool, but I don't really care. Get ignored!"
	};
